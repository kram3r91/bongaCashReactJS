        ...
        <div className="container">
          <div className="profile-model hidden">
            <div className="row">
              ...
              <div className="col-sm-6 col-md-6 col-lg-6">
                <button type="button" className="btn btn-primary btn-sm float-right">Models online with this tag <span className="badge badge-light"></span></button>
              </div>
            </div>
  ...
  componentDidUpdate(){
    ...
    function search(parameter, posts){
      for ( var i = 0; i < posts.length; i++){
        if(posts[i].tags.includes(parameter)){
    ...
    var modelsFromTags = $('.singleModel');
    $('.badge-light').html(modelsFromTags.length);
